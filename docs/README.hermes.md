...
cp -r superpowers-zh/plugins/superpowers-zh/skills /your/project/.hermes/skills
```
...
skills:
  external_dirs:
    - /path/to/superpowers-zh/plugins/superpowers-zh/skills
```
...
完整映射参见 `plugins/superpowers-zh/skills/using-superpowers/references/hermes-tools.md`。
