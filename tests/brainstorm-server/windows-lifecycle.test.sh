...
START_SCRIPT="$REPO_ROOT/plugins/superpowers-zh/skills/brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/plugins/superpowers-zh/skills/brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/plugins/superpowers-zh/skills/brainstorming/scripts/server.js"
