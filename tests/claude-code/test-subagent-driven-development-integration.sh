...
I want you to execute the implementation plan at docs/superpowers/plans/implementation-plan.md using the parallel-executing-plans skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/superpowers/plans/implementation-plan.md using the parallel-executing-plans skill.
...
if grep -q '"name":"Skill".*"skill":"superpowers:parallel-executing-plans"' "$SESSION_FILE"; then
