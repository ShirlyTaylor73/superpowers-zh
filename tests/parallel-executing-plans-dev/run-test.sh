...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superpowers-tests/$TIMESTAMP/parallel-executing-plans"
...
PROMPT="Execute this plan using superpowers:parallel-executing-plans. The plan is at: $PLAN_PATH"
